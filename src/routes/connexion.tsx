...
export const Route = createFileRoute("/connexion")({
  head: () => ({
    meta: [
      { title: "Connexion — StirForma" },
      { name: "description", content: "Connectez-vous à votre espace StirForma pour gérer vos formations." },
      { property: "og:title", content: "Connexion — StirForma" },
...
function ConnexionPage() {
  ...
  useEffect(() => {
    if (isAuthenticated && user) {
      router.navigate({ to: user.role === "admin" ? "/admin" : user.role === "formateur" ? "/formateur/dashboard" : "/catalogue" });
    }
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link to="/inscription" className="text-primary hover:underline">Inscrivez-vous</Link>
          </p>
        </div>
      </div>
    </div>
