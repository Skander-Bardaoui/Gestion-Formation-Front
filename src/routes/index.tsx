        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 pb-24 pt-20 md:grid-cols-12 md:pt-28">
          <div className="md:col-span-7">
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground">
              StirForma centralise vos sessions intra, inter et catalogue : planification,
          ...
          <div className="grid gap-10 md:grid-cols-12 md:gap-16">
            <div className="md:col-span-4">
              ...
              <p className="mt-4 text-muted-foreground">
                De l'organisation pédagogique à la conformité documentaire, StirForma accompagne
